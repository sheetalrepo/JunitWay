...
public class UserWithoutLombok 
{
    ...
    //constructor with builder param
    private UserWithoutLombok(UserBuilder builder) {
    ...
    public static class UserBuilder 
    {
        ...
        //mandatory fields will be part of builder constructor
        ...
        public UserWithoutLombok build() {
            UserWithoutLombok user =  new UserWithoutLombok(this);
            return user;
        }
    }
}
